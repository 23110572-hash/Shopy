...
function HistoryEmpty({ title, reason, kind }: { title: string; reason: string; kind: 'order' | 'transaction' }) {
  return (
    <div className="history-empty">
      <div className="history-empty-icon">{kind === 'order' ? '▤' : '↔'}</div>
